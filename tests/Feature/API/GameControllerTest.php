...
class GameControllerTest extends TestCase
{
    ...
    public function testIndex()
    {
        ...
        withHeaders([
            ...
            ->getJson(route('api.games.index', $parameters));
    ...
    public function testWeekGames()
    {
        ...
        withHeaders([
            ...
            ->getJson(route('api.games.weekGames', $parameters));
    ...
    public function testStore()
    {
        ...
        postJson(route('api.games.store'), [
    ...
    public function testShow()
    {
        ...
        getJson(route('api.games.show', ['gameId' => $game->uuid]));
    ...
    public function testShowNonExistingGame()
    {
        ...
        getJson(route('api.games.show', ['gameId' => 9999]));
    ...
    public function testUpdate()
    {
        ...
        putJson(route('api.games.update', ['gameId' => $game->uuid]), [
            'gameDate' => $date,
            'address' => $address,
        ]);
    ...
    public function testUpdateNonExistingGame()
    {
        ...
        putJson(route('api.games.update', ['gameId' => fake()->uuid]), [
            'gameDate' => Carbon::now()->addDay()->toDateTimeString(),
        ]);
    ...
    public function testAddVolunteers()
    {
        ...
        putJson(route('api.games.addVolunteers', ['gameId' => $game->uuid]), [
    ...
    public function testAddVolunteersNonExistingGame()
    {
        ...
        putJson(route('api.games.addVolunteers', ['gameId' => 9999]), [
            'timekeeperId' => 1,
            'secretaryId' => 1,
            'roomManagerId' => 1,
        ]);
    ...
    public function testDeleteGame()
    {
        ...
        $response = $this->withHeaders([
            'Scorekeep-API-Key' => env('API_PUBLIC_KEY'),
        ])->postJson(route('api.games.delete'), [
            'gameId' => $game->uuid,
        ]);
    ...
    public function testConfirmGame()
    {
        ...
        $response = $this->withHeaders([
            'Scorekeep-API-Key' => env('API_PUBLIC_KEY'),
        ])->postJson(route('api.games.confirm'), [
            'gameId' => $game->uuid,
        ]);
    ...
    public function testCancelGame()
    {
        ...
        $response = $this->withHeaders([
            'Scorekeep-API-Key' => env('API_PUBLIC_KEY'),
        ])->postJson(route('api.games.cancel'), [
            'gameId' => $game->uuid,
        ]);
